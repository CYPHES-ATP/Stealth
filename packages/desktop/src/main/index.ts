...
const APP_IDS: Record<string, string> = {
  dev: "network.cyphes.stealth.dev",
  beta: "network.cyphes.stealth.beta",
  prod: "network.cyphes.stealth",
}
...
const main = Effect.gen(function* () {
  ...
  const appId = app.isPackaged ? APP_IDS[CHANNEL] : "network.cyphes.stealth.dev"
  ...
  app.setName(app.isPackaged ? APP_NAMES[CHANNEL] : "Stealth Dev")
